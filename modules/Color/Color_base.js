...
function applyCombination(tinyColor, fn, args) {
    return fn.apply(null, [tinyColor].concat([].slice.call(args)));
}

function applyModification(tinyColor, fn, args) {
    var color = applyCombination(tinyColor, fn, args);
    tinyColor._r = color._r;
    tinyColor._g = color._g;
    tinyColor._b = color._b;
    tinyColor.setAlpha(color._a);
    return tinyColor;
}
...
TinyColor.prototype = {
    ...
    toRgbString: function() {
        return (this._a === 1) ?
          ...
          "rgba(" + Math.round(this._r) + ", " + 
            Math.round(this._g) + ", " + Math.round(this._b) + ", " + this._roundA + ")";
    },
    toPercentageRgb: function() {
        return { 
          r: Math.round(bound01(this._r, 255) * 100) + "%", 
          g: Math.round(bound01(this._g, 255) * 100) + "%", 
          b: Math.round(bound01(this._b, 255) * 100) + "%", a: this._a
        };
    },
    ...
    toName: function() {
        ...
        return TinyColor.hexNames[rgbToHex(this._r, this._g, this._b, true)] || false;
    },
    ...
    lighten: function() { return applyModification(this, lighten, arguments); },
    brighten: function() { return applyModification(this, brighten, arguments); },
    darken: function() { return applyModification(this, darken, arguments); },
    desaturate: function() { return applyModification(this, desaturate, arguments); },
    saturate: function() { return applyModification(this, saturate, arguments); },
    greyscale: function() { return applyModification(this, greyscale, arguments); },
    spin: function() { return applyModification(this, spin, arguments); },
    analogous: function() { return applyCombination(this, analogous, arguments); },
    complement: function() { return applyCombination(this, complement, arguments); },
    monochromatic: function() { return applyCombination(this, monochromatic, arguments); },
    splitcomplement: function() { return applyCombination(this, splitcomplement, arguments); },
    triad: function() { return applyCombination(this, triad, arguments); },
    tetrad: function() { return applyCombination(this, tetrad, arguments); }
};
...
// `hue2rgb`
// A helper function generally only used by hslToRgb.
...
function hslToRgb(h, s, l) {
    ...
    if(s === 0) {
        rgb.r = rgb.g = rgb.b = l * 255; // achromatic
    } else {
...
function greyscale(color) { return (new TinyColor(color)).desaturate(100); }
...
TinyColor.hexNames = flip(TinyColor.names);
