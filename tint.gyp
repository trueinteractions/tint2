{
	...
	'targets': [
	{
		...
		[ 'OS=="mac"', {
			'libraries': [ '$(SDKROOT)/System/Library/Frameworks/Carbon.framework', '-fobjc-arc'],
			'defines!': [
			'PLATFORM="mac"',
			],
			'defines': [
	...
	# generate ETW header and resource files
	{
		...
		[ 'node_use_etw=="true" and node_has_winsdk=="true"', {
			'actions': [
			{
				...
				'action': [ 'mc <@(_inputs) -h libraries/node/tools/msvs/genfiles -r libraries/node/tools/msvs/genfiles' ]
			}
			]
		} ]
		]
