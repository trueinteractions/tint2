{
  'variables': {
    ...
    'mac_library_files': [
      'modules/Bridge/_class.js',
      'modules/Bridge/_core.js',
      'modules/Bridge/exception.js',
      'modules/Bridge/_id.js',
    ...
    'library_files': [
      'libraries/node/lib/internal/bootstrap_node.js',
      ...
      'libraries/node/lib/internal/cluster.js',
      'libraries/node/lib/internal/freelist.js',
      'libraries/node/lib/internal/linkedlist.js',
      'libraries/node/lib/internal/net.js',
      'libraries/node/lib/internal/module.js',
      'libraries/node/lib/internal/process/next_tick.js',
      'libraries/node/lib/internal/process/promises.js',
      'libraries/node/lib/internal/process/stdio.js',
      'libraries/node/lib/internal/process/warning.js',
      'libraries/node/lib/internal/process.js',
      'libraries/node/lib/internal/readline.js',
      'libraries/node/lib/internal/repl.js',
      'libraries/node/lib/internal/socket_list.js',
      'libraries/node/lib/internal/util.js',
      'libraries/node/lib/internal/v8_prof_polyfill.js',
      'libraries/node/lib/internal/v8_prof_processor.js',
      'libraries/node/lib/internal/streams/lazy_transform.js',
      'libraries/node/deps/v8/tools/splaytree.js',
      'libraries/node/deps/v8/tools/codemap.js',
      'libraries/node/deps/v8/tools/consarray.js',
      'libraries/node/deps/v8/tools/csvparser.js',
      'libraries/node/deps/v8/tools/profile.js',
      'libraries/node/deps/v8/tools/profile_view.js',
      'libraries/node/deps/v8/tools/logreader.js',
      'libraries/node/deps/v8/tools/tickprocessor.js',
      'libraries/node/deps/v8/tools/SourceMap.js',
      'libraries/node/deps/v8/tools/tickprocessor-driver.js',
  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'libraries/node/src/node_revert.cc',
        'libraries/node/src/node_util.cc',
        ...
        'libraries/node/src/node_revert.h',
        ...
        'libraries/node/src/string_search.cc',
